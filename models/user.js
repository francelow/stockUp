...
const userSchema = new Schema({
  ...
  cart: {
    items: [
      {
        productId: { type: Schema.Types.ObjectId, ref: 'Product', required: true }, //'Product' model is referenced here
...
//Define user removeFromCart method
...
module.exports = mongoose.model('User', userSchema); //Mongoose take 'User' into lowercase and plularize
