...
describe('Testing the Product model', function(){
    ...
    it('Fail 1 - Test an invalid Product title', function(){
     
        let newProduct = new Product(0012, "22.00", "Hassle-free party package to enjoy your Friday night","https://i.ibb.co/pW5bG9J/TGIF.jpg" , null, '603eeae6de09a9e8e15b35cd');
        assert.strictEqual(newProduct.isValid(),false);
    
    });
    it('Fail 2 - Test an invalid Product price',  function(){
    ...
    it('Fail 3 - Test an invalid Product description', function(){
       
        let newProduct = new Product( "TGIF party", "22.00", 2213,"https://i.ibb.co/pW5bG9J/TGIF.jpg" , null, '603eeae6de09a9e8e15b35cd');
        assert.strictEqual(newProduct.isValid(), false);
       
    });
    
    it('Success - Test an valid Product object', function(){
       
        let newProduct = new Product( "TGIF party", "22.00", "Hassle-free party package to enjoy your Friday night","https://i.ibb.co/pW5bG9J/TGIF.jpg" , null, '603eeae6de09a9e8e15b35cd');
        assert.strictEqual(newProduct.isValid(), true);
